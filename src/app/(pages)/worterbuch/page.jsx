            ...
            <Fade triggerOnce>
                ...
                <div className="flex flex-row justify-center items-center">
                    <div className="me-9 h-7 w-7">
                        {cards ? (<ArrowIcon data-test="ReturnLettersGrid" size={40} onClick={() => { setCards(null); }} className="bg-orange-card hover:bg-yellow-card cursor-pointer ms-5 rounded-full" />) : (
                            <p />
                        )}
                    </div>
                ...
                {cards ?
                    (cards.length === 0 ?
                        (<h1 data-test="NoCardsFoundNotification" className="mt-[calc(30vh)] text-center">Wir konnten keine Karte finden</h1>) :
