...
const ScrollAreaUpdate = () => (
  <ScrollArea.Root className="h-[330px] lg:w-[670px] rounded overflow-hidden bg-black-card">
    ...
    <ScrollArea.Scrollbar
      className="flex select-none touch-none p-0.5 bg-white-card transition-colors duration-[160ms] ease-out hover:bg-red-card data-[orientation=vertical]:w-2.5 data-[orientation=horizontal]:flex-col data-[orientation=horizontal]:h-2.5"
