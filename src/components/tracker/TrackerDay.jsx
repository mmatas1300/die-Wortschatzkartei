...
const TrackerDay = ({ day, mostPlayed }) => {
    ...
    const setColor = () => {
        const color = day.cardsPlayed == 0 ? "bg-black-card/[var(--day-opacity)]" : "bg-blue-card/[var(--day-opacity)]"
        return color;
    }
            ...
            <div className={`${setColor()} rounded-sm p-2 lg:p-3 relative`} onMouseEnter={() => setShowTooltip(true)} onMouseLeave={() => setShowTooltip(false)}>
                ...
                {showTooltip && (
                    <div
                        ...
                        style={{ top: '110%', left: '50%', transform: 'translateX(-50%)' }} // Posiciona el tooltip debajo del elemento
                    >
